...
FROM_ADDRESS = 'ibrahim.boukhenna@gmail.com'
REPLY_TO_ADDRESS = 'ibrahim.boukhenna@gmail.com'

CLIENTS = [
    {
        # You'll need to verify this email
        'email': 'ibrahim.9007@gmail.com', 
        'first_name': 'Ibrahim',
        'last_name': 'USTHB',
        'pet_name': 'Riley'
    },
...
EMPLOYEES = [
    {
        ...
        'first_name': 'Boukhenna',
        'last_name': 'Ibrahim'
    },
]

# Change to the bucket you create on your AWS account
TEMPLATE_S3_BUCKET = 'gpc-email-templates-iboukhenna'
#
#
